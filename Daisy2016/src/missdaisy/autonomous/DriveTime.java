...
/**
 * A very rudimentary class that simply drives the drive base for some specified amount of time.
 * It also uses a proportional gain on the gyroscopes heading reading in order to drive straight.
 * @author Joshua Sizer
 *
 */
